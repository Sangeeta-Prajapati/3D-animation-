...
Command: npx gltfjsx@6.5.3 dev.gltf --transform 
Files: dev.gltf [124.21KB] > C:\Users\hp\Desktop\react_logo\dev-transformed.glb [43.47KB] (65%)
...
export default function Model(props) {
  const { nodes, materials } = useGLTF('/dev-transformed.glb')
  return (
...
useGLTF.preload('/dev-transformed.glb')
